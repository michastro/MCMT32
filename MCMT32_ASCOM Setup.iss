...
; Generated by Michel Meunier on 13/03/2017 (UTC)
;
[Setup]
AppID={{f5173230-350c-4d65-9726-113c49b8de52}}
AppName=ASCOM MCMT32 Telescope Driver
AppVerName=ASCOM MCMT32 Telescope Driver 2.1.2
AppVersion=2.1.2
...
OutputDir="."
OutputBaseFilename="MCMT32_ASCOM Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\MCMT32"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\MCMT32"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Astro\ASCOM\MCMT32New\MCMT32_ASCOM.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Astro\ASCOM\MCMT32New\Notice.txt"; DestDir: "{app}"; Flags: isreadme
...
#define AppClsid "{{f5173230-350c-4d65-9726-113c49b8de52}"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM MCMT32 Telescope Driver"
...
begin
   ...
   P.Register('MCMT32_ASCOM.Telescope', 'MCMT32_ASCOM');
end;
