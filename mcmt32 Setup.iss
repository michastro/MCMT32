...
OutputDir="."
OutputBaseFilename="MCMT32 Setup"
Compression=lzma
...
[Files]
Source: "C:\Astro\ASCOM\MCMT32New\MCMT32_ASCOM.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Astro\ASCOM\MCMT32New\Notice.txt"; DestDir: "{app}"; Flags: isreadme
...
begin
   ...
   P.Register('MCMT32.Telescope', 'MCMT32_ASCOM');
end;
